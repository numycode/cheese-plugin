...
My server model is "everyone is OP," so permissions are not gated on OP status for this plugin — they use real permission nodes instead:
...
- Paper 26.1.2
- Java 25
- Luckperms or simmilar for a better experience
